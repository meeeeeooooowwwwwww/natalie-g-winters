    ...
    <main class="content-page">
      <article class="content-inner wide-shell">
        <div class="editorial-hero">
          <div>
            <div class="eyebrow">CHINA FILES</div>
            <h1>Natalie Winters: China & CCP Reporting</h1>
            <p class="hero-deck">Chinese Communist Party influence and foreign-influence networks have been among the most persistent themes in Natalie Winters' reporting, from her National Pulse work through War Room and her current independent investigations.</p>
          </div>
          <aside class="hero-aside"><strong>THE RECURRING QUESTION</strong>Which American institutions, journalists, academics, officials or organisations are connected to Chinese state or United Front-linked networks, and what follows from those connections?</aside>
        </div>
        ...
        <div class="prose wide">
          ...
          <p>In December 2025, Winters also interviewed <strong>Taiwan Vice President Hsiao Bi-khim</strong> at Taiwan's Presidential Office. Taiwan's own Presidential Office described Winters as a War Room co-host and White House correspondent and recorded the interview's focus on geopolitics, cross-strait relations, defence, U.S.-Taiwan relations and investment.</p>
        </div>

        <section class="section-block">
          <div class="section-title-row"><h2>Recent China-focused investigations</h2><p>Direct links to selected original Natalie Winters Substack reports.</p></div>
        ...
        <section class="section-block">
          <div class="section-title-row"><h2>Taiwan interview</h2><p>A rare example where the subject of the interview also provides an official institutional record.</p></div>
        ...
        <section class="section-block">
          <div class="section-title-row"><h2>Independent confirmation</h2><p>Sources outside Winters' own platforms documenting the Taiwan interview and her long-running China speciality.</p></div>
