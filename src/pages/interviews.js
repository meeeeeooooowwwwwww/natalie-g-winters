...
export function renderInterviewsPage(posts) {
    ...
    <main class="content-page prestige-page">
      <article class="content-inner prestige-shell">
        ...
        <section class="prestige-section" style="margin-top:34px;padding-top:0;border-top:0">
          <div class="prestige-section-head"><h2>Current conservative media</h2><p>Recent 2026 appearances only. Each destination has been checked before being promoted here.</p></div>
          <div class="appearance-brand-grid">
            ...
            <article class="appearance-brand-card"><div class="appearance-brand-top"><img class="reverse" src="https://upload.wikimedia.org/wikipedia/commons/5/5c/Logo_Real_America%27s_Voice.svg" alt="Real America's Voice" loading="lazy" decoding="async"></div><span>REAL AMERICA'S VOICE · AUGUST 13, 2026</span><h3>War Room PM</h3><p>A current RAV broadcast centred on Winters' investigations into ideological influence in American schools and public institutions.</p><a href="https://rumble.com/v7e4his-war-room-with-steve-bannon-pm-edition.html" target="_blank" rel="noopener noreferrer">WATCH RAV BROADCAST →</a></article>
  ...
  return renderLayout({
    ...
    description: "Natalie G. Winters interviews and media appearances including current 2026 appearances on OAN, Real America's Voice and Glenn Beck, plus PBS, Piers Morgan and international interviews.",
